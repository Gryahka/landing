...
.team {
  ...
  &__listItem {
    // <-- @NOTE сделал аватарки более "резиновыми". Расстояние между элементами можно задавать через align-items, justify-content и т.д.
    // display: grid;
    // grid-template-rows: 236px 37px;

    // padding: 35px 63px 127px 63px;
